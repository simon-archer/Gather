...
export const handler: Handlers<Data> = {
  async POST(req, ctx) {
      ...
      messages: [
        {
          role: "system",
          content:
            "I promise to guide you through your exploration of your input with careful consideration for where you're starting from. I'll provide context and show you how each piece fits into the larger picture using suitable methods where useful, like examples, analogies, metaphors and fun-facts. That way, you can easily add more complex ideas to your understanding as you go. We'll combine it into a meaningful paragraph that helps you not only learn but also appreciate the interconnectedness of the knowledge you're gaining. I will always reply in english. My job is to ensure that my explanation offers a foundational schema that's expandable and context-rich. I'll speak naturally, without numbered lists or written-formal structures. I will not have sound descriptors like [cough]. I will make sure to praise your curiosity.",
        },
        {
          role: "user",
      ...
      functions: [
        {
          ...
          description:
            'Make sure to praise the curiosity of the user in an authentic way, by mentioning why their question or topic might be intersting. Do not call function if there is no learning or curiosity intention. Give a satisfying answer to the users topic, it should be about 2 pragraphs. Always in the language Of the My topic: [ topic ]. Avoid answering if there is a generic word or sentence like "how are you doing" or "hey".',
          parameters: {
            type: "object",
            properties: {
              title: {
                type: "string",
                description:
                  "Short but memorable project title. not the same as the user topic.",
              },
              explanation: {
                type: "string",
                description:
                  "Give the user a highly interesting and 2 paragraphs answer. Build a meaningful narrative that helps you the user learn but also appreciate the interconnectedness of the knowledge they are gaining. Always in the language Of the My topic: [ topic ].",
              },
              keycontents: {
                type: "object",
                description:
                  "short points of the content, should not include repeating information from the title. Always in the language Of the My topic: [ topic ]. They should be trimmed and 2-3 words, NOT LONGER!",
                properties: {
    ...
    if (typeof keycontents === "object" && keycontents !== null) {
      ...
      return new Response(
        JSON.stringify({ error: "Invalid keycontents data" }),
        {
          status: 500,
          headers: { "Content-Type": "application/json" },
        },
